...
mysql_query("INSERT INTO `capsler`(`id`, `email`, `icerik`, `resim`, `begeni`, `yorum`,`sabit`,`tarih`,`tarihler`,gosterim) VALUES ('','$email','','$yolcuk','0','0','0','$tarihcekbugun','$tarihsirala','0')");
...
$capssil2 = $_GET["adi"];
@header("Location: http://cuemk.com/capsyap/capssil.php?id=$capssil2");

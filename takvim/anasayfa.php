...
$menuisim = $yetkisi["ad"];
$menuresim = $yetkisi["resim"];
$menupuan = $yetkisi["paylaspuan"];
...
setInterval("ojidanieNG()", 50)
			...
			<div id="loginregister">                                      <ul class="sosyal2">                <li><a href="karsilama/index.php" target="content">Anasayfa</a></li>								                <li><a href="yenikonu.php" target="content">Yeni Konu Aç</a></li>                <li><a href="uyeler.php" target="content">Üyeler</a></li>                <li><a href="hesap.php" target="content">Hesap Ayarları</a></li>								                <li><a href="panel/">Yönetim Paneli</a></li> <li><a target="_blank"href="https://docs.google.com/forms/d/1cWCa5e1_KaCqt-5vYjjkXeWqQKln1yyuRRlUd9kejb4/edit?usp=sharing">İstek Kutusu</a></li>
			
			
			<li><a href="puanbilgilendirme.php" target="content">Puan Bilgilendirme</a></li>
			
			<li><a href="#" onclick="chatac()">Chat</a></li> 
			<li><a href="cikis.php">Çıkış</a></li>                            </ul>                                                                                               </tbody></table>                                                        </form>                            </div>                              </div>        <!-- SOL ATARAF BİTTİ --><script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>        <div id="container">                   <div id="header">	   	   <div class="basliktext"><?php echo $sitebaslik ?></div><div style=" font-size: 15;color: #8F002E;" class="basliksag">Beta
...
<div id="baslikbild" style="margin-top:15px;">Popülerler</div>
<?php
...
document.getElementById("chat").style.right = "1%";
...
<div id="chat"  class="dynDiv_moveDiv" style="background: #0099cc;height: 435px;width:21%;padding:5px;">
 ...
 <div id="kapat" onClick="chatac()" style="

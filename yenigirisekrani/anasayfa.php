...
<script src="img/bildirim.js"></script>
			...
			<div class="menu-wrap">
				<nav class="menu-top">
					<div class="profile"><img src="<?php echo $menuresim ?>" style="max-width: 40;"/><span><?php echo $menuisim ?></span></div>
					<div class="icon-list">
...
document.getElementById("chat").style.right = "5%";
...
<div id="chat" onClick="chatac()" class="chatacilis">Chat
<iframe id="chatfirat" src="chatfirat/index.php" style="width:0;height:0;  transition:all 2s;"  frameborder="0" scrolling="0"></iframe>

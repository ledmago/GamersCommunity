...
setInterval("ojidanieNG()", 50)
			...
			<li><a href="cikis.php">Çıkış</a></li>                            </ul>                                                                                               </tbody></table>                                                        </form>                            </div>                              </div>        <!-- SOL ATARAF BİTTİ --><script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>        <div id="container">                   <div id="header">	   	   <div class="basliktext"><?php echo $sitebaslik ?></div><div class="basliksag">
...
<div id="chat" onClick="chatac()" class="dynDiv_moveDiv" style="background: #0099cc;height: 435px;width:21%;padding:5px;">

...
<div class="iclogo" style="color:#111;font-size:25px;">Yeni Konu Aç<div style="margin-top:10px"></div>
<form method="post">

<input type="text" name="emailleri" placeholder="Kişinin Email Adresi" style="width:50%;margin-bottom:10px;">
...
mysql_query("INSERT INTO gelenkutusu (id,konu,mesaj,goster,okundu) VALUES ('','$emailler','$icerik','1','0')");

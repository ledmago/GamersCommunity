...
<table cellspacing='0' width="100%"> <!-- cellspacing='0' is important, must stay -->
	<tr><th>Sıra</th><th>Profil Resmi</th><th>Adı Soyadı</th><th>Puanı</th></tr><!-- Table Header -->
    
	
	<?php
	include("ayar.php");
	mysql_query("SET NAMES UTF8"); 
	$sorgu=mysql_query("SELECT * FROM uyeler2 Order By paylaspuan DESC LIMIT 100"); 
	$sira = 0;
		while($gonderi = mysql_fetch_array($sorgu))   
			...
			echo'<tr><td>'.$sira.'</td><td><img src="'.$resim.'"width="64" height="64" stylE="border-radius:100%;"></td><td>'.$ad.'</td><td>'.$paylaspuan.'</td></tr>';
			}

...
<script src="img/bildirim.js"></script>
			...
			<div class="menu-wrap">
				<nav class="menu-top">
					<div class="profile"><img src="<?php echo $menuresim ?>" alt="Matthew Greenberg"/><span><?php echo $menuisim ?></span></div>
					<div class="icon-list">

...
<table cellspacing='0' width="100%"> <!-- cellspacing='0' is important, must stay -->
	...
	<tr><th colspan="4">&nbsp;</tr><!-- Table Header -->
	...
	<tr><td colspan="4">Cevap Yaz<br>
<form method="post">


<textarea type="text" style="margin-top:5px;padding:5px;color:#444;width: 50%;height: 70px;" name="yenimesaj">Mesajınız</textarea><br>

...
$email_kendi = $_SESSION["email"];
	...
	$sorgus = "SELECT * FROM mezdeke_gonderi WHERE id='$idals'";
...
$uyelers = mysql_fetch_array($admin_sorgus); 
	...
	$sorgusx = "SELECT * FROM mezdeke_gonderi WHERE id='$idals'";
...
mysql_query("UPDATE `mezdeke_gonderi` SET `icerik`='$gelencek' WHERE id='$idals'");

				@header("Location: konu.php?id=$idals&alan=mezdeke");					

...
<section class="col-lg-12 connectedSortable">
		  ...
		  <div class="callout callout-success">
                    ...
                    <input type="text" class="form-control" name="icerik2" value="<?php echo $_GET["icerik2"]; ?>">
		  ...
		  <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <table class="table table-condensed">
					...
					$icerik2 =  $_GET["icerik2"];
					
					$sayfa=$_GET['sayfa'];
		if ($sayfa=="" || !is_numeric($sayfa)) { $sayfa='1';}
		$kacar=90;
		$kayit_sayisi=mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM uyeler2 where ad like '%$icerik2%' or email like '%$icerik2%'"));
		$sayfa_sayisi=$kayit_sayisi['0']/$kacar;
		if ($kayit_sayisi%$kacar!=0) {$sayfa_sayisi++;}$nerden=($sayfa*$kacar)-$kacar;
		mysql_query("SET NAMES UTF8");$sorgu=mysql_query("SELECT * FROM uyeler2 where ad like '%$icerik2%' or email like '%$icerik2%' ORDER BY yetki DESC, id LIMIT $nerden,$kacar");
